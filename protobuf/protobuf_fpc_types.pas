...
resourcestring
  ...
  sProtoBufNotFondProperty        = 'ProtoBuffer: Not fond property %s';
  sProtoBufErrorReadQWordValue    = 'ProtoBuffer: Error read QWord value';
  sProtoBufErrorReadInt64Value    = 'ProtoBuffer: Error read int64 value';
